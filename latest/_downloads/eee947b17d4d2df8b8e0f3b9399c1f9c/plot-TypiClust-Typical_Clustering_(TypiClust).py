...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//pool/plot-TypiClust-Typical_Clustering_(TypiClust).ipynb
#
...
qs = TypiClust(random_state=0, cluster_algo_dict={"random_state": 0})
...
# .. rubric:: References:
# 
# The implementation of this strategy is based on :footcite:t:`hacohen2022active`.
#
# .. footbibliography::
