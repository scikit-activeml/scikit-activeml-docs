...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//pool/plot-GreedySamplingTarget-Greedy_Sampling_on_the_Target_Space_(GSy).ipynb
#
...
qs = GreedySamplingTarget(method='GSy')
