...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//pool/plot-QueryByCommittee-Query-by-Committee_(QBC)_with_Variation_Ratios.ipynb
#
...
qs = QueryByCommittee(method='variation_ratios', sample_predictions_method_name='sample_proba', sample_predictions_dict={'n_samples': 100})
...
# .. rubric:: References:
# 
# The implementation of this strategy is based on :footcite:t:`seung1992query` and :footcite:t:`beluch2018power`.
#
# .. footbibliography::
