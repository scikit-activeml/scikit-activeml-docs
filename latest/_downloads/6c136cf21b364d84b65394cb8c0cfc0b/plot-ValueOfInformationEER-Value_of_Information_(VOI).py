...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//pool/plot-ValueOfInformationEER-Value_of_Information_(VOI).ipynb
#
...
# .. rubric:: References:
# 
# The implementation of this strategy is based on :footcite:t:`kapoor2007selective`.
#
# .. footbibliography::
