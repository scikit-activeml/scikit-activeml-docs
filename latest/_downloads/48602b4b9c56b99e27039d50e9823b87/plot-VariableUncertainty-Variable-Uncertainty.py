...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//stream/plot-VariableUncertainty-Variable-Uncertainty.ipynb
#
...
qs = VariableUncertainty(budget=0.2)
plot_step = 5
