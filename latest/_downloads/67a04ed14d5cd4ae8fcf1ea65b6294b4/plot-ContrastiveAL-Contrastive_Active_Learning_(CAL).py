...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//pool/plot-ContrastiveAL-Contrastive_Active_Learning_(CAL).ipynb
#
...
qs = ContrastiveAL(random_state=0)
...
# .. rubric:: References:
# 
# The implementation of this strategy is based on :footcite:t:`margatina2021active`.
#
# .. footbibliography::
