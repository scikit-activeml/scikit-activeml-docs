...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//pool/plot-CoreSet-Core_Set.ipynb
#
...
# .. rubric:: References:
# 
# The implementation of this strategy is based on :footcite:t:`sener2017active`.
#
# .. footbibliography::
