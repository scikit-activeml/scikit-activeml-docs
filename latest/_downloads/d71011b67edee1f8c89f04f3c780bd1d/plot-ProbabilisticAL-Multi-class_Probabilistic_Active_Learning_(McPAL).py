...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//pool/plot-ProbabilisticAL-Multi-class_Probabilistic_Active_Learning_(McPAL).ipynb
#
...
for c in range(n_cycles):
    ...
    ax = plot_utilities(qs, X=X, y=y, clf=clf, utility_weight=dens,
