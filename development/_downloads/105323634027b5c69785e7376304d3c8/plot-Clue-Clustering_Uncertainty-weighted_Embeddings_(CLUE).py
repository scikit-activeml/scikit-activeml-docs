...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//pool/plot-Clue-Clustering_Uncertainty-weighted_Embeddings_(CLUE).ipynb
#
