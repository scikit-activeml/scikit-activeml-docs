...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//pool/plot-Falcun-Fast_Active_Learning_by_Contrastive_UNcertainty_(FALCUN).ipynb
#
...
for c in range(n_cycles):
    ...
    query_idx, utilities = qs.query(
        X=X, y=y, clf=clf, batch_size=4, return_utilities=True
    )
...
# .. rubric:: References:
# 
# The implementation of this strategy is based on :footcite:t:`gilhuber2024falcun`.
#
# .. footbibliography::
