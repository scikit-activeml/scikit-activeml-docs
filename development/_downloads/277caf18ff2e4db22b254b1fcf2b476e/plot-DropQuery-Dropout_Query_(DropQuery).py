...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//pool/plot-DropQuery-Dropout_Query_(DropQuery).ipynb
#
...
# .. rubric:: References:
# 
# The implementation of this strategy is based on :footcite:t:`gupte2024revisiting`.
#
# .. footbibliography::
