...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//pool/plot-EpistemicUncertaintySampling-Epistemic_Uncertainty_Sampling_(EpisUS).ipynb
#
...
# .. rubric:: References:
# 
# The implementation of this strategy is based on :footcite:t:`nguyen2019epistemic`.
#
# .. footbibliography::
