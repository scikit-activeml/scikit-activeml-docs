...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//stream/plot-CognitiveDualQueryStrategyFixUn-Cognitive_Dual-Query_Strategy_with_Fixed-Uncertainty.ipynb
#
...
from skactiveml.stream import CognitiveDualQueryStrategyFixUn
...
qs = CognitiveDualQueryStrategyFixUn(budget=0.2, classes=[0, 1])
plot_step = 5
