...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//pool/plot-UncertaintySampling-Density-weighted_Uncertainty_Sampling.ipynb
#
...
for c in range(n_cycles):
    ...
    ax = plot_utilities(
        qs,
        X=X, y=y, clf=clf, utility_weight=density,
        candidates=unlabeled_indices(y), replace_nan=None,
        res=25,
...
# .. rubric:: References:
# 
# The implementation of this strategy is based on :footcite:t:`tang2002active`.
#
# .. footbibliography::
