...
qs = VOI(cost_matrix=[[0, 1], [1, 0]], labeling_cost=1, random_state=random_state)
...
for c in range(n_cycles):
    ...
    ax = plot_utility(qs, {'clf': clf, 'X': X, 'y': y}, X_cand=X_cand, feature_bound=feature_bound, ax=ax)
