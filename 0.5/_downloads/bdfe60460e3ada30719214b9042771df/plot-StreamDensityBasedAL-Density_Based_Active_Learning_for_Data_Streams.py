...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//stream/plot-StreamDensityBasedAL-Density_Based_Active_Learning_for_Data_Streams.ipynb
#
...
from skactiveml.stream import StreamDensityBasedAL
...
qs = StreamDensityBasedAL(budget=0.2)
plot_step = 5
...
# .. rubric:: References:
# 
# The implementation of this strategy is based on :footcite:t:`ienco2014density`.
#
# .. footbibliography::
