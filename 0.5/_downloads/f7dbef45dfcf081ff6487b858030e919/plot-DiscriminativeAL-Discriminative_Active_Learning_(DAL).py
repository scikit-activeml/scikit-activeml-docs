...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//pool/plot-DiscriminativeAL-Discriminative_Active_Learning_(DAL).ipynb
#
...
for c in range(n_cycles):
    ...
    query_idx = qs.query(X=X, y=y, discriminator=discriminator)
    ...
    ax = plot_utilities(qs, X=X, y=y, discriminator=discriminator,
...
# .. rubric:: References:
# 
# The implementation of this strategy is based on :footcite:t:`gissin2019discriminative`.
#
# .. footbibliography::
