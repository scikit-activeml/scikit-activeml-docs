...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//pool/plot-GreedyBALD-Bayesian_Active_Learning_by_Disagreement_(BALD).ipynb
#
...
from skactiveml.pool import GreedyBALD
...
qs = GreedyBALD(random_state=random_state)
...
for c in range(n_cycles):
    ...
    ax = plot_utilities(qs, X=X, y=y, ensemble=clf,
                        replace_nan=None, candidates=X[unlabeled_indices(y)], res=25,
