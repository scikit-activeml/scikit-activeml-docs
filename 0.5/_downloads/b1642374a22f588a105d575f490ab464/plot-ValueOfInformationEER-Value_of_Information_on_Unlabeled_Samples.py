...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//pool/plot-ValueOfInformationEER-Value_of_Information_on_Unlabeled_Samples.ipynb
#
...
for c in range(n_cycles):
    ...
    ax = plot_utilities(qs, X=X, y=y, clf=clf, ignore_partial_fit=True,
...
# .. rubric:: References:
# 
# The implementation of this strategy is based on :footcite:t:`joshi2009multi`.
#
# .. footbibliography::
