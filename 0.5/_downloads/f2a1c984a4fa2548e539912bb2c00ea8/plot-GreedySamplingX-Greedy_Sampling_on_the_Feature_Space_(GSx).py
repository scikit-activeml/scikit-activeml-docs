...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//pool/plot-GreedySamplingX-Greedy_Sampling_on_the_Feature_Space_(GSx).ipynb
#
...
for c in range(n_cycles):
    ...
    _, utilities_test = qs.query(
        X=X, y=y, candidates=X_test, return_utilities=True
    )
...
# .. rubric:: References:
# 
# The implementation of this strategy is based on :footcite:t:`wu2019active`.
#
# .. footbibliography::
