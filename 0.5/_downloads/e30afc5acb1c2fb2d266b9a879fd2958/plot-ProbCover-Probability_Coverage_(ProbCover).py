...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//pool/plot-ProbCover-Probability_Coverage_(ProbCover).ipynb
#
...
qs = ProbCover(n_classes=2, random_state=0, cluster_algo_dict={"random_state": 0})
...
# .. rubric:: References:
# 
# The implementation of this strategy is based on :footcite:t:`yehuda2022active`.
#
# .. footbibliography::
