...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml-docs/blob/gh-pages/latest/generated/sphinx_gallery_notebooks//pool/plot-CostEmbeddingAL-Active_Learning_with_Cost_Embedding_(ALCE).ipynb
#
...
qs = CostEmbeddingAL(classes=[0, 1])
...
# .. rubric:: References:
# 
# The implementation of this strategy is based on :footcite:t:`huang2016novel`.
#
# .. footbibliography::
