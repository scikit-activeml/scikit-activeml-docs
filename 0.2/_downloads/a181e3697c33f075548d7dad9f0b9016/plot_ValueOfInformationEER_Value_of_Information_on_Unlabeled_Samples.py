...
qs = ValueOfInformationEER(consider_unlabeled=True, consider_labeled=False, candidate_to_labeled=True, subtract_current=True, normalize=True, random_state=random_state)
